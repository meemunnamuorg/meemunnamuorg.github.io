...
! function () {
  var t;
  window.ms_caption_fade = function (i, n, o, a) {
...
! function () {
  var t;
  window.ms_caption_move = function (i, e, a, o) {
    var n = jQuery,
      s = [{
        left1: "100%",
        top2: "100%"
...
//function ms_caption_parallax(t, n, i, a, s, o) {
//  var e = jQuery;
//  n.parent().css({
//      position: "absolute",
//      top: 0,
...
//          v = u + c * (r ? 1 : -1),
//          g = (r ? -1 : 1) * u;
//        p(n, h).show(), p(i, 0).show(), p(d, g), p(f, 0), p(w, 2 * g), p(l, 0), mswAnimate(function (t) {
//          t = e.easing.swing(t), p(n, (1 - t) * h), p(i, t * v)
//        }, 0, 1, t.duration);
//        var m = .8;
//        mswAnimate(function (t) {
...
function ms_caption_slide(t, e, o, i) {
  function r(t, e) {
  ...
  }), window.ms_caption_traces = function (i, o, n, a) {
    function r(t) {
      var e, i = parseInt,
        t = t.replace(/\s\s*/g, "");
...
jQuery.fn.mwsslider = function (t) {
    function e(t) {
      return I.css({
        left: -t + "00%"
      })
    ...
    function i(e) {
      if (window["ms_" + e]) {
        var n = new window["ms_" + e](t, $, O);
        n.name = "ms_" + e, B.push(n)
      }
    }
    ...
    function l() {
      A.find(".ms_effect").fadeOut(200), e(G).fadeIn(200).find("img").css({
        visibility: "visible"
      })
    }
    ...
    function f(e, n, i, a, o, s) {
      ...
      e[0] || (e = k(e)), e.on((n ? "mousedown " : "") + "touchstart", function (e) {
        ...
        2 == t.gestures && A.addClass("ms_grabbing"), f = 0, n ? (r = n.pageX, c = n.pageY, d = p = 1, a && (d = p = a(e))) : d = p = 0, e.originalEvent.touches || (e.preventDefault(), e.stopPropagation())
        ...
        2 == t.gestures && A.removeClass("ms_grabbing"), d && (f && o && o(e, l, u), !f && s && s(e), f && (e.preventDefault(), e.stopPropagation()), f = 0, d = 0)
    ...
    function y() {
      ...
      function n(t) {
        0 > t && (t = 0), D && D.loadTtip(t), k(v.get(x)).removeClass("ms_overbull"), k(v.get(t)).addClass("ms_overbull"), b.show();
        var e = {
      ...
      A.find(".ms_bullets a,.ms_thumbs a").click(function (t) {
        w(t, k(this).index())
      });
      var i;
      if (de.length) {
        ...
        A.find(".ms_thumbs a").each(function (t, e) {
          u(e, 0, 0, function (t) {
            return !!k(t.target).parents(".ms_thumbs").get(0)
          }, function () {
            r = 1
          }, function (t) {
            w(t, k(e).index())
      ...
      if (fe.length) {
        var m = fe.find(">div"),
          ...
          g = v.find("IMG");
        if (g.length) {
          var b = k('<div class="ms_bulframe"/>').appendTo(m),
            y = k("<div/>").css({
              width: g.length + 1 + "00%"
          ...
          m.hover(function () {
            ...
            v.removeClass("ms_overbull"), document.all ? _ || (_ = setTimeout(function () {
              b.hide(), _ = 0
            }, 400)) : b.stop().animate({
              opacity: 0
            }, {
    ...
    function x(t) {
      k("A", de).each(function (e) {
        ...
        } else k(this).removeClass("ms_selthumb")
      })
    }

    function _(t) {
      k("A", fe).each(function (e) {
        e == t ? k(this).addClass("ms_selbull") : k(this).removeClass("ms_selbull")
      })
    }
    ...
    function F() {
      t.autoPlay = !t.autoPlay, t.autoPlay ? (v(), je.removeClass("ms_play"), je.addClass("ms_pause"), J && J.start(G)) : (P.wsStop(), je.removeClass("ms_pause"), je.addClass("ms_play"))
    }
    ...
    function C() {
      /msw Slider/g.test(j) || (S() ? document[Ie.exitFullscreen]() : (De = 1, A.wrap("<div class='ms_fs_wrapper'></div>").parent()[0][Ie.requestFullscreen]()))
    }
    ...
    var k = jQuery,
      A = this,
      P = A.get(0);
    window.ms_basic = function (t, e, n) {
      var i = k(this);
      this.go = function (e) {
        n.find(".ms_list").css("transform", "translate3d(0,0,0)").stop(!0).animate({
      ...
      autoPlayVideo: !1,
      responsive: 1,
      support: jQuery.fn.mwsslider.support,
      stopOnHover: 0,
      preventCopy: 1
    }, t);
    var j = navigator.userAgent,
      O = k(".ms_images", A).css("overflow", "visible"),
      ...
      I = O.find("ul").css("width", "100%").wrap("<div class='ms_list'></div>").parent().appendTo(q);
    k("<div>").css({
      position: "relative",
      width: "100%",
      "font-size": 0,
    ...
    var D = t.images && new mwssliderPreloader(this, t),
      z = O.find("li"),
      N = z.length,
      ...
      L = k("<div>").addClass("ms_swipe_left").css(W).prependTo(I),
      R = k("<div>").addClass("ms_swipe_right").css(W).appendTo(I);
    ...
    var X, Y;
    t.preventCopy && (X = k('<div class="ms_cover"><a href="#" style="display:none;position:absolute;left:0;top:0;width:100%;height:100%"></a></div>').css({
      position: "absolute",
      left: 0,
      top: 0,
      width: "100%",
    ...
    2 == t.gestures && A.addClass("ms_gestures");
    var ne = O,
      ie = '$#"';
    if (ie && (ie = r(ie))) {
      if (t.gestures) {
        ...
        u(O, 2 == t.gestures, function (e, n) {
          ...
          var e = /ms_playpause|ms_prev|ms_next|ms_bullets/g.test(t.target.className) || k(t.target).parents(".ms_bullets").get(0),
          ...
          Z--, k(B[0]).trigger("effectStart", {
            ...
            start: function () {
              ...
              function n() {
                re ? i > a || -a > i ? k(B[0]).trigger("effectEnd") : mswAnimate(function (t) {
...
(function($){
	...
	var effectsPath = (SITE_URL || 'http://meemunnamu.org/')+'images/effects/';
	...
	function controlDeviceButtons(msw, callback) {
		// device buttons
		var sliderCont = msw.parent(),
			curResponsive = 1;
		function resizeWnd() {
		...
		$('#devices').on('click', 'a', function(e) {
			...
			if(/laptop|tablet|mobile/g.test(thisClass)) {
				...
				if(/boxed/g.test(thisClass)) {
					...
					$('#'+msw.attr('id')+' .ms_fullscreen').click();
					return;
				}
				$('#devices').find('.boxed, .fullwidth, .fullscreen').removeClass('checked');
	...
	var cSlide, bkpCont, mswInstance, firstInitBtns;

	
	var default_mwsslider = $.fn.mwsslider;
	var default_options;
	var newOptions;
	$.fn.mwsslider = function (options) {
		if(!default_options) {
		...
		if(!firstInitBtns) {
			...
			if(msw.attr('data-fullscreen')) {
				msw.parent().css('max-width', 'none');
			}

			if(msw.attr('data-no-devices')) {
				$('#devices').remove();
			} else {
				controlDeviceButtons(msw, function(newOpts) {
					if(newOptions.responsive !== newOpts.responsive) {
						newOptions.responsive = newOpts.responsive;
						newOptions.forceStart = 0;
						mswReInitor(mswInstance, newOptions);
					}
				});
			...
			if(msw.attr('data-effects')) {
				$('#devices').remove();
				allEfects = msw.attr('data-effects').split("|");
			}
		}

		$.getScript(effectsPath+newOptions.effect+".js", function(){
			newOptions.support = default_mwsslider.support;
			...
			if (!bkpCont){
				bkpCont = $(document.createElement("div")).append(msw.clone()).html();	
			...
			var result = default_mwsslider.apply(msw, [new_opt]); 
			
			if (isNaN(cSlide))
				cSlide = 0;
			else if(newOptions.forceStart)
				msw.get(0).wsStart(cSlide+1);
	...
	window.mswReInitor = function (msw,options){
		$(msw).mwsslider(options);
	};
})(jQuery);
