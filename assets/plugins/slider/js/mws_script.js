...
function ms_blast(q, j, m) {
  var e = jQuery;
  var i = e(this);
  var f = m.find(".ms_list");
  var a = q.distance || 1;
  var g = e("<div>").addClass("ms_effect ms_blast");
  var c = e("<div>").addClass("ms_zoom").appendTo(g);
  var k = e("<div>").addClass("ms_parts").appendTo(g);
  m.css({
    overflow: "visible"
  }).append(g);
  g.css({
...
jQuery("#mwsslider-contentbox").mwsslider({
  effect: "blast",
  prev: "",
  next: "",
  duration: 20 * 100,
